defmodule Apartmentex.TestAdapter do
  @behaviour Apartmentex.Adapter
...
Application.put_env(:ecto, Apartmentex.TestRepo, [user: "invalid"])

defmodule Apartmentex.TestRepo do
  use Ecto.Repo, otp_app: :ecto, adapter: Apartmentex.TestAdapter
end

Apartmentex.TestRepo.start_link(url: "ecto://user:pass@local/hello")
