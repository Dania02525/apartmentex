defmodule Apartmentex.Adapters.SQL do
  @moduledoc """
  ...
  defmacro __using__(adapter) do
    quote do
      ...
      @behaviour Apartmentex.Adapter.Migration
      @behaviour Apartmentex.Adapter.Transaction
      ...
      def rollback(repo, value) do
        Apartmentex.Adapters.SQL.rollback(repo, value)
      end
